namespace MComms_Transmuxer.Common
{
    ...
    public class EndianBinaryWriter : IDisposable
    {
        ...
        public EndianBinaryWriter (Stream stream, Encoding encoding) : this(stream, encoding, false)
        {
        }
        ...
        public EndianBinaryWriter(Stream stream, Encoding encoding, bool leaveOpen)
        {
            ...
            this.stream = stream;
            this.Endiannes = EndianBinaryWriter.GlobalEndiannes;
        ...
        public static Endianness GlobalEndiannes
        {
            ...
            set { EndianBinaryWriter.globalEndiannes = value; }
        }
