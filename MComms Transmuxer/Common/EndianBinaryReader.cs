namespace MComms_Transmuxer.Common
{
    ...
    public class EndianBinaryReader : IDisposable
    {
        ...
        public EndianBinaryReader(Stream stream) : this (stream, Encoding.UTF8, false)
        {
        }

        /// <summary>
        /// Constructs a new binary reader with the given stream with the option
        /// to leave stream open on object dispose.
        /// </summary>
        /// <param name="stream">Stream to read data from</param>
        /// <param name="leaveOpen">Leave stream open on object dispose</param>
        public EndianBinaryReader(Stream stream, bool leaveOpen) : this(stream, Encoding.UTF8, leaveOpen)
        {
        }
        ...
        public EndianBinaryReader(Stream stream, Encoding encoding) : this(stream, encoding, false)
        {
        }
        ...
        public EndianBinaryReader(Stream stream, Encoding encoding, bool leaveOpen)
        {
            ...
            this.stream = stream;
            this.Endiannes = EndianBinaryReader.GlobalEndiannes;
        ...
        /// <summary>
        /// Default endianness for all binary readers
        /// </summary>
        public static Endianness GlobalEndiannes
        {
            get { return EndianBinaryReader.globalEndiannes; }
            set { EndianBinaryReader.globalEndiannes = value; }
        }

        private Endianness endiannes = EndianBinaryReader.globalEndiannes;
        /// <summary>
        /// Current endianness. Can be changed before any read
        /// </summary>
        public Endianness Endiannes
        {
            ...
            set
            {
                this.endiannes = value;
                switch (this.endiannes)
                {
                    case Endianness.BigEndian:
                        this.bitConverter = this.bigEndianBitConverter;
                        break;
                    case Endianness.LittleEndian:
                        this.bitConverter = this.littleEndianBitConverter;
                        break;
                }
            }
        }
        ...
        /// <summary>
        /// Reads a 32-bit signed integer from the stream, using the bit converter
        /// for this reader. byteCount bytes are read (eg 3 bytes).
        /// </summary>
        ...
        /// <summary>
        /// Reads a 32-bit signed integer from the stream, using specified bit converter.
        /// byteCount bytes are read (eg 3 bytes).
        /// </summary>
        /// <param name="byteCount">Number of bytes to read</param>
        /// <param name="endianness">Endian type</param>
        /// <returns>The 32-bit integer read</returns>
        ...
        /// <summary>
        /// Reads a 32-bit unsigned integer from the stream, using specified bit converter.
        /// byteCount bytes are read (eg 3 bytes).
        /// </summary>
        /// <param name="byteCount">Number of bytes to read</param>
        /// <param name="endianness">Endian type</param>
        ...
        public uint ReadUInt32(int byteCount, Endianness endianness)
        {
            ...
            switch (endianness)
            {
                ...
                case Endianness.LittleEndian:
                    return littleEndianBitConverter.ToUInt32(buffer, 0);
                default:
                    return bitConverter.ToUInt32(buffer, 0);
            }
        }
