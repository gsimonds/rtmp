...
namespace MComms_TransmuxerTests
{
    ...
    /// <summary>
    ///This is a test class for RtmpMessageAbortTest and is intended
    ///to contain all RtmpMessageAbortTest Unit Tests
    ///</summary>
    [TestClass()]
    public class RtmpMessageAbortTest
    {
        ...
        {
            int targetChunkStreamId = 4;
            RtmpMessageAbort target = new RtmpMessageAbort(targetChunkStreamId);
            ...
            {
                0x02,0x00,0x00,0x00,0x00,0x00,0x04,0x02,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x04,
            };
