...
namespace MComms_TransmuxerTests
{
    ...
    /// <summary>
    ///This is a test class for RtmpMessageWindowAckSizeTest and is intended
    ///to contain all RtmpMessageWindowAckSizeTest Unit Tests
    ///</summary>
    [TestClass()]
    public class RtmpMessageWindowAckSizeTest
    {
        ...
        public void ToRtmpChunkTest()
        {
            ...
            RtmpMessageWindowAckSize target = new RtmpMessageWindowAckSize(ackSize);
            ...
            {
                0x02,0x00,0x00,0x00,0x00,0x00,0x04,0x05,0x00,0x00,0x00,0x00,0x00,0x10,0x00,0x00,
            };
